...
//tealium universal tag - utag.sender.6026 ut4.0.201606160336, Copyright 2016 Tealium.com Inc. All Rights Reserved.
try {
  (function (id, loader) {
    var u = {};
    ...
    u.calc_items = function(quan) {
      ...
      u.map={"fb_conv_pixel_id":"conv_pixel","page_type:category":"ViewContent","page_type:product":"ViewContent","page_type:orderconfirmation":"Purchase,Conversion","event_type:addToCart":"AddToCart","fb_content_type":"vc.content_type,cart.content_type,purch.content_type"};
  u.extend=[function(a,b){ try{ if(typeof b['order_id']!='undefined'&&b['order_id']!=''){b['fb_conv_pixel_id']='6007506428768'} } catch(e){ utag.DB(e) }  },
function(a,b,c,d,e,f,g){d=b['page_type'];if(typeof d=='undefined')return;c=[{'product':'product'},{'orderconfirmation':'product'}];var m=false;for(e=0;e<c.length;e++){for(f in c[e]){if(d==f){b['fb_content_type']=c[e][f];m=true};};if(m)break};},
function(a,b){ try{ if((typeof b['event_type']!='undefined'&&b['event_type'].toString().toLowerCase()=='addToCart'.toLowerCase())){b['fb_content_type']='product'} } catch(e){ utag.DB(e) }  }];
      ...
      for(c=0;c<u.extend.length;c++){try{d=u.extend[c](a,b);if(d==false)return}catch(e){}};
        ...
        if (u.initialized) {
          ...
          if (!u.scriptrequested) {
            ...
            u.loader({"type": "script",  "src": u.data.base_url, "cb": u.callBack, "loc": "script", "id": 'utag_358'});
            //FB PreLoad Code
            !function (f, b, e) {
